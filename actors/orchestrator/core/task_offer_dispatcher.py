...
BeamCore publishes task-offer batches without an offer ACK. This queue keeps
worker websocket delivery asynchronous so NATS message handling stays independent
